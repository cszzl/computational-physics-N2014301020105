# -*- coding: utf-8 -*-
"""
Created on Sun Nov 27 19:26:33 2016
...
title(r'$\alpha=0.02$',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
...
title(r'$\alpha=0.01$',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
...
title(r'$\alpha=0.003$',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
...
title(r'$\alpha=0.001$',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
